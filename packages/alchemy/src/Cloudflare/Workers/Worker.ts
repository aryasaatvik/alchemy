...
export interface ViteOptions {
   ...
   * the Vite root (`rootDir`), whichever directory the deploy runs from.
   * Any other value is a module id that Vite's plugin pipeline resolves
   * as-is — e.g. a virtual module (`virtual:flue/worker`) or a package
   * specifier — so a plugin can own the Worker entry.
   *
   ...
   * @example
   * ```typescript
   * // an entry generated by a Vite plugin
   * vite: { main: "virtual:flue/worker" }
   * ```
   */
  main?: string;
  /**
