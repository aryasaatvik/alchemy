...
/**
 * The config-owned companion to a Vite-backed Cloudflare Worker.
 *
 * A standalone Vite invocation uses the supplied options. During an Alchemy
 * build, a framework-created nested Vite invocation receives the active
