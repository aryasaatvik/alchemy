// Fixture: a dev process that ignores SIGTERM and starts a descendant in its
// process group that ignores SIGTERM too. Only group-wide SIGKILL escalation
// reaps both. Writes both pids to PID_FILE.
